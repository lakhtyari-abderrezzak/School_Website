<div id="sidebar" class="fixed inset-0 z-50 lg:w-64 w-0 lg:flex flex-col bg-gray-800 text-white transition-all duration-300 ease-in-out">
    <div class="flex justify-between items-center p-4 border-b border-gray-700">
      ...
      <ul class="space-y-2 p-4">
        ...
        <x-nav-link :active="request()->is('dashboard/administration')" :href="route('administration')" class="block py-2 px-4  " wire:navigate >Administration</x-nav-link>
      </ul>
