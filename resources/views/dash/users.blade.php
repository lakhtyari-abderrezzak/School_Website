    ...
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-6">
            ...
            <a href="{{ route('users.create') }}" wire:navigate
                class="text-white bg-indigo-600 py-2 px-4 my-4 rounded-lg">Create a
                User</a>
            @if (!$users->isEmpty())
                <!-- Table -->
                <div class="overflow-x-auto">
                    ...
                    <form method="GET" action="{{ route('users') }}"
                        ...
                        <select name="sort_by_role"
                            ...
                            <option value="teacher" {{ request('sort_by_role') === 'teacher' ? 'selected' : '' }}>
                                Teacher
                            </option>
                            <option value="student" {{ request('sort_by_role') === 'student' ? 'selected' : '' }}>
                                Student
                            </option>
                            <option value="administration"
                                {{ request('sort_by_role') === 'administration' ? 'selected' : '' }}>Administration
                            </option>
                        </select>
