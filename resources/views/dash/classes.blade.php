<x-app-layout>
    <div class="flex h-screen">
        ...
        <div class="flex-1 p-6">
            ...
            <a wire:navigate class=" text-white bg-indigo-600 hover:bg-indigo-800 py-2 px-4 rounded-lg mb-4 "
                href="{{ route('subjects.create') }}">Create New Class</a>
            @if (!$subjects->isEmpty())
                            ...
                            @foreach ($subjects as $class)
                                <tr class="border-b hover:bg-gray-100">
                                    ...
                                    <td class="py-3 px-6 flex justify-center items-center space-x-4">
                                        ...
                                        <a href="{{ route('subjects.edit', $class) }}"
                                        ...
                                        @if (Auth::user()->is_principal)
                                            <form action="{{ route('subjects.destroy', $class->id) }}" method="POST"
